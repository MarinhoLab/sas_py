...
"""
@file example_robot_driver_subclass.py
@brief Example subclass of marinholab.sas.core.RobotDriver in Python.

This module provides a minimal example showing how to subclass the
`marinholab.sas.core.RobotDriver` Python binding and implement the required
methods. It is intended for documentation and testing purposes only.
"""

import numpy as np
from marinholab.sas.core import RobotDriver, ShutdownSignaler
